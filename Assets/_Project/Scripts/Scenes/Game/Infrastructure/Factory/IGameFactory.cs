...
namespace _Project.Scripts.Scenes.Game.Infrastructure.Factory
{
  public interface IGameFactory
  {
    ...
    UniTask<HackingTerminal> SpawnTerminal(Vector3 position, Quaternion rotation, Transform warZoneTransform, string id, CombatZone combatZone);
    ...
    UniTask<TurretBase> SpawnTurret(Vector3 position);
  }
}